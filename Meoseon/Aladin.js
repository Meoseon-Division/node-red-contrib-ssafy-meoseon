  ...
  function AladinNode(config) {
    ...
    node.on('input', (msg, send, done) => {
      ...
      if (node.params.RequestType === 'ItemSearch') {
        node.params['QueryType'] =
          msg.QueryType || msg.QueryType1 || node.params['QueryType']
      } else {
        node.params['QueryType'] =
          msg.QueryType || msg.QueryType2 || node.params['QueryType']
      }
